# f0f2da5 (2011-08-04 13:48:21 +0200) Stephane Poss <stephane.guillaume.poss@cern.ch>
"""
    This is a comment
"""
...
#moduleInstance5.addParameter(Parameter("outputData_1",'',"string","self","outputData_1",True,False,"list of output data"))
