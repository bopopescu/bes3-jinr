...
"""
__RCSID__ = "8bc9b8d (2012-06-06 15:17:59 +0200) Adri Casajs <adria@ecm.ub.es>"
    ...
    for fileName in os.listdir( dirToDo ):
      ...
      if os.path.isdir( objPath ):
        ...
        if fileName.find( '.py', len( fileName ) - 3 ) == len( fileName ) - 3 :
          ...
          fd.close()
          changed = False
          for keyWord, cmdArgs in ( ( '8bc9b8d (2012-06-06 15:17:59 +0200) Adri Casajs <adria@ecm.ub.es>', '--pretty="%h (%ad) %an <%aE>" --date=iso' ),
                                    ( '8bc9b8d9a6bd1a693db5b28e1520257558403ecc', '--pretty="%H"' ) ):
